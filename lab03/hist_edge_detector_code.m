...
Mimg=strcat('Histogram_Edge_bds',num2str(filenum),'_rad_',num2str(rad),'_num_orient_',num2str(num_orient),'_num_bins_',num2str(num_bins),'.jpg');
imwrite(M,Mimg);
...
% 
threshed=strcat('Histogram_Edge_bds',num2str(filenum),'thresh_',num2str(thresh),'_rad_',num2str(rad),'_num_orient_',num2str(num_orient),'_num_bins_',num2str(num_bins),'.jpg');
imwrite(MB,threshed);
% % BW = im2bw(M, 0.999999);
figure;
imshow(MB);
